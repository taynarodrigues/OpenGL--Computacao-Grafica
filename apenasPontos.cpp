...
int main(int argc, char** argv){
  ...
  glutCreateWindow ("Exemplo projecoes: Apenas os Pontos");              // cria a janela
  init();
...
void display(void){
  ...
  glBegin(GL_POINTS);
    ...
    glVertex3f(50.0,150.0,0); //ponto negro

    glVertex3f(50.0,50.0,0); //ponto negro

    glVertex3f(150.0,50.0,0); //ponto negro

    glVertex3f(150.0,150.0,0); //ponto negro

    glVertex3f(50.0,150.0,0); //ponto negro

    glVertex3f(100.0,200.0,0); //ponto negro
