...
int main(int argc, char** argv){
    ...
    glutCreateWindow("Exemplo projecoes dois pontinhos");               //cria a janela
    init();                                              
...
void init(void){
  ...
  // glFrustum(GLdouble left, GLdouble rigth, GLdouble bottom, GLdouble top, GLdouble linear_, GLdouble far_);
// glFrustum(0, 256,256, 0, -40.0, 1.0);
}
...
void display(void){
  ...
  glColor3f(0.0, 0.0, 0.0);      //cor do ponto
    ...
    glVertex3f(100.0,100.0,-2.0);
     glVertex3f(100.0,100.0,-4.0);
 glEnd();
...
//  g++ doisPontinhos3003.cpp -o firstOpenGlApp -lglut -lGLU -lGL
// ./firstOpenGlApp