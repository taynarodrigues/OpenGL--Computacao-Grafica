...
int main(int argc, char** argv){
  ...
  glutCreateWindow ("Exemplo Rotacao Casinha");              // cria a janela
  init();
...
void display(void){
  ...
  glBegin(GL_LINE_STRIP);
    ...
    glVertex3f(50.0,150.0,0); 

    glVertex3f(50.0,50.0,0); 

    glVertex3f(150.0,50.0,0); 

    glVertex3f(150.0,150.0,0); 

    glVertex3f(50.0,150.0,0); 

    glVertex3f(100.0,200.0,0); 
...
//  g++ rotacaoCasinha.cpp -o firstOpenGlApp -lglut -lGLU -lGL
// ./firstOpenGlApp