...
int main(int argc, char** argv){
  ...
  glutCreateWindow ("Exemplo Solido Vermelho");              // cria a janela
  init();
...
glPushMatrix(); //Bola Vermelha
glTranslatef (150.0, 150.0, 0.0); //quadrado preto
glutSolidCube(40.0);
glPopMatrix();
...
//  g++ solidoVermelho.cpp -o firstOpenGlApp -lglut -lGLU -lGL
// ./firstOpenGlApp